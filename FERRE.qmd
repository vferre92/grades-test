...
```
Problème : le délimitateur est un '.' au lieu de ',' ; et les missing values ne sont pas encodées en NA. Changeons cela :

```{r}

grades <- read_delim("grades.csv", delim = ":", na = "unknown")
