...
students |>
  ggplot(aes(x = Age)) +
  geom_histogram(aes(y = after_stat(density)), binwidth = 1, fill = "lightblue", color = "white") +
  geom_density(bw = "sj", linewidth = 1, color = "darkblue") +
  labs(title = "Distribution of Students' Age", x = "Age",y = "Density") +
  theme_bw() +
  theme(plot.title = element_text(hjust = 0.5))
```
